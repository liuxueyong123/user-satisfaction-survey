"use strict";Object.defineProperty(exports,Symbol.toStringTag,{value:"Module"});const n=require("lit"),a=require("lit/decorators.js"),m=require("lit/directives/class-map.js"),d=require("lit/directives/style-map.js"),c=require("lit/directives/repeat.js"),u="user-satisfaction";var f=Object.defineProperty,x=Object.getOwnPropertyDescriptor,l=(s,e,t,o)=>{for(var i=o>1?void 0:o?x(e,t):e,p=s.length-1,h;p>=0;p--)(h=s[p])&&(i=(o?h(e,t,i):h(i))||i);return o&&i&&f(e,t,i),i};let r=class extends n.LitElement{constructor(){super(...arguments),this.questionList=[],this.questionIndex=0,this.isVisible=!1,this.styles={},this._answers=[]}willUpdate(s){if(s.has("isVisible")){const e=s.get("isVisible");e===!1?this.styles={animation:"0.4s ease forwards fadeIn",display:"block"}:e===!0&&(this.styles={animation:"0.5s ease forwards fadeOut",display:"block"})}}render(){var e;const s=(e=this.questionList[this.questionIndex])==null?void 0:e.content;return n.html`
    ...
    `}renderProgressText(){return n.html`<div class="progress-text" style=${d.styleMap({opacity:this.questionIndex===0?"0":"100%"})}>${this.questionIndex+1}/${this.questionList.length}</div>`}renderProgressBar(){return n.html`
      <div class="progress-bar" style=${d.styleMap({opacity:this.questionIndex===0?"0":"100%"})}>
        ${c.repeat(this.questionList,s=>s.id,(s,e)=>n.html`<div class="${m.classMap({"progress-item":!0,"is-done":e<this.questionIndex,"is-active":e===this.questionIndex})}"></div>`)}
      </div>
    `}renderRate(){return n.html`
      <div class="rate-wrapper">
        ${c.repeat(["rate5","rate4","rate3","rate2","rate1"],s=>s,(s,e)=>n.html`
  ...
  `;l([a.property({type:Array})],r.prototype,"questionList",2);l([a.property({type:Number})],r.prototype,"questionIndex",2);l([a.property({type:Boolean})],r.prototype,"isVisible",2);l([a.property()],r.prototype,"styles",2);r=l([a.customElement(u)],r);const w=r;class g{constructor(e=[]){this._listenerDestroyers=[];const t=document.createElement(u);this._element=t,e.length>0&&this.addQuestions(e),document.body.appendChild(this._element)}async launch(){await this._element.updateComplete,this._element.isVisible=!0}close(){this._element.isVisible=!1}destroy(){document.body.removeChild(this._element);for(const e of this._listenerDestroyers)e();this._element=null,this._listenerDestroyers=null}setQuestions(e){this._element.questionList=e}removeQuestionById(e){if(this._element.questionIndex===this._element.questionList.length-1&&this._element.questionList[this._element.questionIndex].id===e)throw new Error("无法删除当前正在填写的最后一个问题！");this._element.questionIndex=this._element.questionIndex-this._element.questionList.slice(0,this._element.questionIndex).filter(t=>t.id===e).length,this._element.questionList=this._element.questionList.filter(t=>t.id!==e)}removeQuestionByIds(e){if(this._element.questionList.slice(this._element.questionIndex).every(t=>e.includes(t.id)))throw new Error("无法直接删除所有待填写问题！");this._element.questionIndex=this._element.questionIndex-this._element.questionList.slice(0,this._element.questionIndex).filter(t=>!e.includes(t.id)).length,this._element.questionList=this._element.questionList.filter(t=>!e.includes(t.id))}addQuestion(e,t=-1){t===-1?this._element.questionList.push(e):this._element.questionList.splice(t+1,0,e),this._element.requestUpdate()}addQuestions(e,t=-1){t===-1?this._element.questionList.push(...e):this._element.questionList.splice(t,0,...e),this._element.requestUpdate()}on(e,t){const o=i=>{t(i.detail)};this._element.addEventListener(e,o),this._listenerDestroyers.push(()=>{this._element.removeEventListener(e,o)})}}exports.UserSatisfactionElement=w;exports.UserSatisfactionSurvey=g;
