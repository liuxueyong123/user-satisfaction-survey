 ...
 */
const N = globalThis, J = N.ShadowRoot && (N.ShadyCSS === void 0 || N.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, K = Symbol(), rt = /* @__PURE__ */ new WeakMap();
let yt = class {
  constructor(t, e, s) {
...
const qt = (n) => new yt(typeof n == "string" ? n : n + "", void 0, K), It = (n, ...t) => {
...
}, ot = J ? (n) => n : (n) => n instanceof CSSStyleSheet ? ((t) => {
  let e = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Ot, defineProperty: Mt, getOwnPropertyDescriptor: Rt, getOwnPropertyNames: Ht, getOwnPropertySymbols: Nt, getPrototypeOf: Bt } = Object, y = globalThis, lt = y.trustedTypes, Dt = lt ? lt.emptyScript : "", V = y.reactiveElementPolyfillSupport, T = (n, t) => n, B = { toAttribute(n, t) {
  switch (t) {
    case Boolean:
      n = n ? Dt : null;
      break;
  ...
  return e;
} }, G = (n, t) => !Ot(n, t), at = { attribute: !0, type: String, converter: B, reflect: !1, hasChanged: G };
...
class S extends HTMLElement {
  ...
  _$AK(t, e) {
    ...
    if (i !== void 0 && this._$Em !== i) {
      const o = s.getPropertyOptions(i), h = typeof o.converter == "function" ? { fromAttribute: o.converter } : ((r = o.converter) == null ? void 0 : r.fromAttribute) !== void 0 ? o.converter : B;
...
S.elementStyles = [], S.shadowRootOptions = { mode: "open" }, S[T("elementProperties")] = /* @__PURE__ */ new Map(), S[T("finalized")] = /* @__PURE__ */ new Map(), V == null || V({ ReactiveElement: S }), (y.reactiveElementVersions ?? (y.reactiveElementVersions = [])).push("2.0.4");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
\f\r]`, L = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ct = /-->/g, pt = />/g, A = RegExp(`>|${F}(?:([^\\s"'>=/]+)(${F}*=${F}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), dt = /'/g, ut = /"/g, bt = /^(?:script|style|textarea|title)$/i, zt = (n) => (t, ...e) => ({ _$litType$: n, strings: t, values: e }), E = zt(1), g = Symbol.for("lit-noChange"), $ = Symbol.for("lit-nothing"), ft = /* @__PURE__ */ new WeakMap(), w = x.createTreeWalker(x, 129);
function wt(n, t) {
...
const xt = (n, t) => {
  ...
  for (let h = 0; h < e; h++) {
    ...
    for (; d < l.length && (o.lastIndex = d, u = o.exec(l), u !== null); )
      d = o.lastIndex, o === L ? u[1] === "!--" ? o = ct : u[1] !== void 0 ? o = pt : u[2] !== void 0 ? (bt.test(u[2]) && (i = RegExp("</" + u[2], "g")), o = A) : u[3] !== void 0 && (o = A) : o === A ? u[0] === ">" ? (o = i ?? L, a = -1) : u[1] === void 0 ? a = -2 : (a = o.lastIndex - u[2].length, c = u[1], o = u[3] === void 0 ? A : u[3] === '"' ? ut : dt) : o === ut || o === dt ? o = A : o === ct || o === pt ? o = L : (o = A, i = void 0);
    const p = o === A && n[h + 1].startsWith("/>") ? " " : "";
    r += o === L ? l + jt : a >= 0 ? (s.push(c), l.slice(0, a) + X + l.slice(a) + m + p) : l + m + (a === -2 ? h : p);
  }
  return [wt(n, r + (n[e] || "<?>") + (t === 2 ? "</svg>" : "")), s];
};
class M {
  constructor({ strings: t, _$litType$: e }, s) {
    ...
    this.parts = [];
    let r = 0, o = 0;
    const h = t.length - 1, l = this.parts, [c, u] = xt(t, e);
    if (this.el = M.createElement(c, s), w.currentNode = this.el.content, e === 2) {
      ...
      if (i.nodeType === 1) {
        if (i.hasAttributes())
          for (const a of i.getAttributeNames())
            if (a.endsWith(X)) {
              const d = u[o++], p = i.getAttribute(a).split(m), f = /([.?@])?(.*)/.exec(d);
              l.push({ type: 1, index: r, name: f[2], strings: p, ctor: f[1] === "." ? Et : f[1] === "?" ? St : f[1] === "@" ? Pt : R }), i.removeAttribute(a);
            } else
              a.startsWith(m) && (l.push({ type: 6, index: r }), i.removeAttribute(a));
        if (bt.test(i.tagName)) {
          const a = i.textContent.split(m), d = a.length - 1;
          if (d > 0) {
            i.textContent = D ? D.emptyScript : "";
            for (let p = 0; p < d; p++)
              i.append(a[p], k()), w.nextNode(), l.push({ type: 2, index: ++r });
            i.append(a[d], k());
          }
        }
...
function C(n, t, e = n, s) {
  ...
  return (i == null ? void 0 : i.constructor) !== r && ((h = i == null ? void 0 : i._$AO) == null || h.call(i, !1), r === void 0 ? i = void 0 : (i = new r(n), i._$AT(n, e, s)), s !== void 0 ? (e._$Co ?? (e._$Co = []))[s] = i : e._$Cl = i), i !== void 0 && (t = C(n, i._$AS(n, t.values), i, s)), t;
}
class Ct {
  constructor(t, e) {
  ...
  u(t) {
    ...
    w.currentNode = i;
    let r = w.nextNode(), o = 0, h = 0, l = s[0];
    for (; l !== void 0; ) {
      if (o === l.index) {
        let c;
        l.type === 2 ? c = new P(r, r.nextSibling, this, t) : l.type === 1 ? c = new l.ctor(r, l.name, l.strings, this, t) : l.type === 6 && (c = new Lt(r, this, t)), this._$AV.push(c), l = s[++h];
      }
...
class P {
  ...
  _$AI(t, e = this) {
    t = C(this, t, e), O(t) ? t === $ || t == null || t === "" ? (this._$AH !== $ && this._$AR(), this._$AH = $) : t !== this._$AH && t !== g && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : At(t) ? this.k(t) : this._(t);
  }
  S(t) {
  ...
  _(t) {
    this._$AH !== $ && O(this._$AH) ? this._$AA.nextSibling.data = t : this.T(x.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    var r;
    const { values: e, _$litType$: s } = t, i = typeof s == "number" ? this._$AC(t) : (s.el === void 0 && (s.el = M.createElement(wt(s.h, s.h[0]), this.options)), s);
    if (((r = this._$AH) == null ? void 0 : r._$AD) === i)
      this._$AH.p(e);
    else {
      const o = new Ct(i, this), h = o.u(this.options);
      o.p(e), this.T(h), this._$AH = o;
    }
  }
  _$AC(t) {
    let e = ft.get(t.strings);
    return e === void 0 && ft.set(t.strings, e = new M(t)), e;
  }
  k(t) {
    ...
    let s, i = 0;
    for (const r of t)
      i === e.length ? e.push(s = new P(this.S(k()), this.S(k()), this, this.options)) : s = e[i], s._$AI(r), i++;
...
class R {
  ...
  _$AI(t, e = this, s, i) {
    ...
    let o = !1;
    if (r === void 0)
      t = C(this, t, e, 0), o = !O(t) || t !== this._$AH && t !== g, o && (this._$AH = t);
    else {
      const h = t;
      let l, c;
      for (t = r[0], l = 0; l < r.length - 1; l++)
        c = C(this, h[s + l], e, l), c === g && (c = this._$AH[l]), o || (o = !O(c) || c !== this._$AH[l]), c === $ ? t = $ : t !== $ && (t += (c ?? "") + r[l + 1]), this._$AH[l] = c;
    }
    o && !i && this.j(t);
  }
  j(t) {
...
const Vt = { P: X, A: m, C: tt, M: 1, L: xt, R: Ct, D: At, V: C, I: P, H: R, N: St, U: Pt, B: Et, F: Lt }, W = q.litHtmlPolyfillSupport;
W == null || W(M, P), (q.litHtmlVersions ?? (q.litHtmlVersions = [])).push("3.1.2");
const Ft = (n, t, e) => {
  const s = (e == null ? void 0 : e.renderBefore) ?? t;
  let i = s._$litPart$;
  if (i === void 0) {
    const r = (e == null ? void 0 : e.renderBefore) ?? null;
    s._$litPart$ = i = new P(t.insertBefore(k(), r), r, void 0, e ?? {});
  }
  return i._$AI(n), i;
};
/**
...
var gt;
I._$litElement$ = !0, I.finalized = !0, (gt = globalThis.litElementHydrateSupport) == null || gt.call(globalThis, { LitElement: I });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Yt = { attribute: !0, type: String, converter: B, reflect: !1, hasChanged: G }, Qt = (n = Yt, t, e) => {
  ...
  if (r === void 0 && globalThis.litPropertyMetadata.set(i, r = /* @__PURE__ */ new Map()), r.set(e.name, n), s === "accessor") {
    ...
    return { set(h) {
      ...
      t.set.call(this, h), this.requestUpdate(o, l, n);
    }, init(h) {
      return h !== void 0 && this.P(o, void 0, n), h;
    } };
  }
  if (s === "setter") {
    const { name: o } = e;
    return function(h) {
      const l = this[o];
      t.call(this, h), this.requestUpdate(o, l, n);
    };
  }
  throw Error("Unsupported decorator location: " + s);
};
function j(n) {
  return (t, e) => typeof e == "object" ? Qt(n, t, e) : ((s, i, r) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const et = { ATTRIBUTE: 1, CHILD: 2, PROPERTY: 3, BOOLEAN_ATTRIBUTE: 4, EVENT: 5, ELEMENT: 6 }, st = (n) => (...t) => ({ _$litDirective$: n, values: t });
let it = class {
  constructor(t) {
  }
  get _$AU() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Zt = st(class extends it {
  constructor(n) {
    var t;
    if (super(n), n.type !== et.ATTRIBUTE || n.name !== "class" || ((t = n.strings) == null ? void 0 : t.length) > 2)
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ut = "important", Jt = " !" + Ut, Q = st(class extends it {
  constructor(n) {
    var t;
    if (super(n), n.type !== et.ATTRIBUTE || n.name !== "style" || ((t = n.strings) == null ? void 0 : t.length) > 2)
  ...
  update(n, [t]) {
    ...
    for (const s in t) {
      ...
      if (i != null) {
        this.ft.add(s);
        const r = typeof i == "string" && i.endsWith(Jt);
        s.includes("-") || r ? e.setProperty(s, r ? i.slice(0, -11) : i, r ? Ut : "") : e[s] = i;
      }
    }
    return g;
  }
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { I: Kt } = Vt, $t = () => document.createComment(""), U = (n, t, e) => {
  var r;
  const s = n._$AA.parentNode, i = t === void 0 ? n._$AB : t._$AA;
  if (e === void 0) {
    const o = s.insertBefore($t(), i), h = s.insertBefore($t(), i);
    e = new Kt(o, h, n, n.options);
  } else {
    const o = e._$AB.nextSibling, h = e._$AM, l = h !== n;
    if (l) {
      let c;
      (r = e._$AQ) == null || r.call(e, n), e._$AM = n, e._$AP !== void 0 && (c = n._$AU) !== h._$AU && e._$AP(c);
    }
    if (o !== i || l) {
      let c = e._$AA;
      for (; c !== o; ) {
  ...
  return e;
}, b = (n, t, e = n) => (n._$AI(t, e), n), Gt = {}, Xt = (n, t = Gt) => n._$AH = t, te = (n) => n._$AH, Z = (n) => {
  var s;
...
const _t = (n, t, e) => {
  ...
  for (let i = t; i <= e; i++)
    s.set(n[i], i);
  return s;
}, mt = st(class extends it {
  constructor(n) {
    if (super(n), n.type !== et.CHILD)
  ...
  update(n, [t, e, s]) {
    const i = te(n), { values: r, keys: o } = this.dt(t, e, s);
    if (!Array.isArray(i))
      return this.ut = o, r;
    const h = this.ut ?? (this.ut = []), l = [];
    let c, u, a = 0, d = i.length - 1, p = 0, f = r.length - 1;
    for (; a <= d && p <= f; )
      if (i[a] === null)
        a++;
      else if (i[d] === null)
        ...
        l[f] = b(i[a], r[f]), U(n, l[f + 1], i[a]), a++, f--;
      else if (h[d] === o[p])
        l[p] = b(i[d], r[p]), U(n, i[a], i[d]), d--, p++;
      else if (c === void 0 && (c = _t(o, p, f), u = _t(h, a, d)), c.has(h[a]))
        if (c.has(h[d])) {
          const _ = u.get(o[p]), z = _ !== void 0 ? i[_] : null;
          if (z === null) {
            const nt = U(n, i[a]);
            b(nt, r[p]), l[p] = nt;
          } else
            l[p] = b(z, r[p]), U(n, i[a], z), i[_] = null;
          p++;
        } else
          Z(i[d]), d--;
      else
    ...
    return this.ut = o, Xt(n, l), g;
  }
}), Tt = "user-satisfaction";
var ee = Object.defineProperty, se = Object.getOwnPropertyDescriptor, H = (n, t, e, s) => {
...
let v = class extends I {
  ...
  render() {
    var t;
    const n = (t = this.questionList[this.questionIndex]) == null ? void 0 : t.content;
    return E`
  ...
  renderProgressText() {
    return E`<div class="progress-text" style=${Q({ opacity: this.questionIndex === 0 ? "0" : "100%" })}>${this.questionIndex + 1}/${this.questionList.length}</div>`;
  }
  renderProgressBar() {
    return E`
      ...
      this.questionList,
      (n) => n.id,
      (n, t) => E`<div class="${Zt({ "progress-item": !0, "is-done": t < this.questionIndex, "is-active": t === this.questionIndex })}"></div>`
    )}
      </div>
    `;
  }
...
H([
  j({ type: Array })
], v.prototype, "questionList", 2);
H([
  j({ type: Number })
], v.prototype, "questionIndex", 2);
H([
  j({ type: Boolean })
], v.prototype, "isVisible", 2);
H([
  j()
], v.prototype, "styles", 2);
v = H([
  Wt(Tt)
], v);
const oe = v;
class le {
  constructor(t = []) {
    ...
    this._element = e, t.length > 0 && this.addQuestions(t), document.body.appendChild(this._element);
  }
  /**
  ...
  destroy() {
    ...
    for (const t of this._listenerDestroyers)
      t();
   ...
   * @return {*}
   */
  removeQuestionById(t) {
    if (this._element.questionIndex === this._element.questionList.length - 1 && this._element.questionList[this._element.questionIndex].id === t)
      throw new Error("无法删除当前正在填写的最后一个问题！");
    this._element.questionIndex = this._element.questionIndex - this._element.questionList.slice(0, this._element.questionIndex).filter((e) => e.id === t).length, this._element.questionList = this._element.questionList.filter((e) => e.id !== t);
  }
  /**
   ...
   * @return {*}
   */
  removeQuestionByIds(t) {
    if (this._element.questionList.slice(this._element.questionIndex).every((e) => t.includes(e.id)))
      throw new Error("无法直接删除所有待填写问题！");
    this._element.questionIndex = this._element.questionIndex - this._element.questionList.slice(0, this._element.questionIndex).filter((e) => !t.includes(e.id)).length, this._element.questionList = this._element.questionList.filter((e) => !t.includes(e.id));
  }
  /**
   ...
   */
  addQuestion(t, e = -1) {
    e === -1 ? this._element.questionList.push(t) : this._element.questionList.splice(e + 1, 0, t), this._element.requestUpdate();
  }
  /**
   ...
   */
  addQuestions(t, e = -1) {
    e === -1 ? this._element.questionList.push(...t) : this._element.questionList.splice(e, 0, ...t), this._element.requestUpdate();
  }
  on(t, e) {
    const s = (i) => {
      e(i.detail);
    };
    this._element.addEventListener(t, s), this._listenerDestroyers.push(() => {
      this._element.removeEventListener(t, s);
    });
  }
}
export {
  oe as UserSatisfactionElement,
  le as UserSatisfactionSurvey
};
