(function(i,n){typeof exports=="object"&&typeof module<"u"?n(exports,require("lit"),require("lit/decorators.js"),require("lit/directives/class-map.js"),require("lit/directives/style-map.js"),require("lit/directives/repeat.js")):typeof define=="function"&&define.amd?define(["exports","lit","lit/decorators.js","lit/directives/class-map.js","lit/directives/style-map.js","lit/directives/repeat.js"],n):(i=typeof globalThis<"u"?globalThis:i||self,n(i.UserSatisfactionSurvey={},i.lit,i.decorators_js,i.classMap_js,i.styleMap_js,i.repeat_js))})(this,function(i,n,l,f,d,u){"use strict";const m="user-satisfaction";var x=Object.defineProperty,w=Object.getOwnPropertyDescriptor,p=(s,e,t,a)=>{for(var r=a>1?void 0:a?w(e,t):e,h=s.length-1,c;h>=0;h--)(c=s[h])&&(r=(a?c(e,t,r):c(r))||r);return a&&r&&x(e,t,r),r};let o=class extends n.LitElement{constructor(){super(...arguments),this.questionList=[],this.questionIndex=0,this.isVisible=!1,this.styles={},this._answers=[]}willUpdate(s){if(s.has("isVisible")){const e=s.get("isVisible");e===!1?this.styles={animation:"0.4s ease forwards fadeIn",display:"block"}:e===!0&&(this.styles={animation:"0.5s ease forwards fadeOut",display:"block"})}}render(){var e;const s=(e=this.questionList[this.questionIndex])==null?void 0:e.content;return n.html`
    ...
    `}renderProgressText(){return n.html`<div class="progress-text" style=${d.styleMap({opacity:this.questionIndex===0?"0":"100%"})}>${this.questionIndex+1}/${this.questionList.length}</div>`}renderProgressBar(){return n.html`
      <div class="progress-bar" style=${d.styleMap({opacity:this.questionIndex===0?"0":"100%"})}>
        ${u.repeat(this.questionList,s=>s.id,(s,e)=>n.html`<div class="${f.classMap({"progress-item":!0,"is-done":e<this.questionIndex,"is-active":e===this.questionIndex})}"></div>`)}
      </div>
    `}renderRate(){return n.html`
      <div class="rate-wrapper">
        ${u.repeat(["rate5","rate4","rate3","rate2","rate1"],s=>s,(s,e)=>n.html`
    ...
    `}_onCloseClick(){this.isVisible=!1,this.dispatchEvent(new CustomEvent("close",{bubbles:!1,detail:null}))}_onRateClick(s){const e={index:this.questionIndex,questionId:this.questionList[this.questionIndex].id,score:s};this._answers.push(e),this.dispatchEvent(new CustomEvent("questionCompleted",{bubbles:!1,detail:e})),this.questionIndex<this.questionList.length-1?this.questionIndex++:(this.isVisible=!1,setTimeout(()=>{this.questionIndex=0},500),this.dispatchEvent(new CustomEvent("completed",{bubbles:!1,detail:this._answers})),this._answers=[])}};o.styles=n.css`
    @keyframes fadeIn {
      0% {
        opacity: 0;
  ...
  `,p([l.property({type:Array})],o.prototype,"questionList",2),p([l.property({type:Number})],o.prototype,"questionIndex",2),p([l.property({type:Boolean})],o.prototype,"isVisible",2),p([l.property()],o.prototype,"styles",2),o=p([l.customElement(m)],o);const v=o;class g{constructor(e=[]){this._listenerDestroyers=[];const t=document.createElement(m);this._element=t,e.length>0&&this.addQuestions(e),document.body.appendChild(this._element)}async launch(){await this._element.updateComplete,this._element.isVisible=!0}close(){this._element.isVisible=!1}destroy(){document.body.removeChild(this._element);for(const e of this._listenerDestroyers)e();this._element=null,this._listenerDestroyers=null}setQuestions(e){this._element.questionList=e}removeQuestionById(e){if(this._element.questionIndex===this._element.questionList.length-1&&this._element.questionList[this._element.questionIndex].id===e)throw new Error("无法删除当前正在填写的最后一个问题！");this._element.questionIndex=this._element.questionIndex-this._element.questionList.slice(0,this._element.questionIndex).filter(t=>t.id===e).length,this._element.questionList=this._element.questionList.filter(t=>t.id!==e)}removeQuestionByIds(e){if(this._element.questionList.slice(this._element.questionIndex).every(t=>e.includes(t.id)))throw new Error("无法直接删除所有待填写问题！");this._element.questionIndex=this._element.questionIndex-this._element.questionList.slice(0,this._element.questionIndex).filter(t=>!e.includes(t.id)).length,this._element.questionList=this._element.questionList.filter(t=>!e.includes(t.id))}addQuestion(e,t=-1){t===-1?this._element.questionList.push(e):this._element.questionList.splice(t+1,0,e),this._element.requestUpdate()}addQuestions(e,t=-1){t===-1?this._element.questionList.push(...e):this._element.questionList.splice(t,0,...e),this._element.requestUpdate()}on(e,t){const a=r=>{t(r.detail)};this._element.addEventListener(e,a),this._listenerDestroyers.push(()=>{this._element.removeEventListener(e,a)})}}i.UserSatisfactionElement=v,i.UserSatisfactionSurvey=g,Object.defineProperty(i,Symbol.toStringTag,{value:"Module"})});
