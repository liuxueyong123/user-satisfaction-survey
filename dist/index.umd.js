(function(i,s){typeof exports=="object"&&typeof module<"u"?s(exports,require("lit"),require("lit/decorators.js"),require("lit/directives/class-map.js"),require("lit/directives/style-map.js"),require("lit/directives/repeat.js")):typeof define=="function"&&define.amd?define(["exports","lit","lit/decorators.js","lit/directives/class-map.js","lit/directives/style-map.js","lit/directives/repeat.js"],s):(i=typeof globalThis<"u"?globalThis:i||self,s(i.UserSatisfactionSurvey={},i.lit,i.decorators_js,i.classMap_js,i.styleMap_js,i.repeat_js))})(this,function(i,s,a,m,d,u){"use strict";const f="user-satisfaction";var x=Object.defineProperty,v=Object.getOwnPropertyDescriptor,l=(p,e,t,o)=>{for(var n=o>1?void 0:o?v(e,t):e,h=p.length-1,c;h>=0;h--)(c=p[h])&&(n=(o?c(e,t,n):c(n))||n);return o&&n&&x(e,t,n),n};let r=class extends s.LitElement{constructor(){super(...arguments),this.questionList=[],this.questionIndex=0,this.isVisible=!1,this.styles={},this._answers=[]}willUpdate(e){if(e.has("isVisible")){const t=e.get("isVisible");t===!1?this.styles={animation:"0.4s ease forwards fadeIn",display:"block"}:t===!0&&(this.styles={animation:"0.5s ease forwards fadeOut",display:"block"})}}render(){var t;const e=(t=this.questionList[this.questionIndex])==null?void 0:t.content;return s.html`
    ...
    `}renderProgressText(){return s.html`<div class="progress-text" style=${d.styleMap({opacity:this.questionIndex===0?"0":"100%"})}>${this.questionIndex+1}/${this.questionList.length}</div>`}renderProgressBar(){return s.html`
      <div class="progress-bar" style=${d.styleMap({opacity:this.questionIndex===0?"0":"100%"})}>
        ${u.repeat(this.questionList,e=>e.id,(e,t)=>s.html`<div class="${m.classMap({"progress-item":!0,"is-done":t<this.questionIndex,"is-active":t===this.questionIndex})}"></div>`)}
      </div>
    `}renderRate(){return s.html`
      <div class="rate-wrapper">
        ${u.repeat(["rate5","rate4","rate3","rate2","rate1"],e=>e,(e,t)=>s.html`
  ...
  `,l([a.property({type:Array})],r.prototype,"questionList",2),l([a.property({type:Number})],r.prototype,"questionIndex",2),l([a.property({type:Boolean})],r.prototype,"isVisible",2),l([a.property()],r.prototype,"styles",2),r=l([a.customElement(f)],r);const w=r;let y=class{constructor(e=[]){this._listenerDestroyers=[];const t=document.createElement(f);this._element=t,e.length>0&&this.addQuestions(e),document.body.appendChild(this._element)}async launch(){await this._element.updateComplete,this._element.isVisible=!0}close(){this._element.isVisible=!1}destroy(){document.body.removeChild(this._element);for(const e of this._listenerDestroyers)e();this._element=null,this._listenerDestroyers=null}setQuestions(e){this._element.questionList=e}removeQuestionById(e){if(this._element.questionIndex===this._element.questionList.length-1&&this._element.questionList[this._element.questionIndex].id===e)throw new Error("无法删除当前正在填写的最后一个问题！");this._element.questionIndex=this._element.questionIndex-this._element.questionList.slice(0,this._element.questionIndex).filter(t=>t.id===e).length,this._element.questionList=this._element.questionList.filter(t=>t.id!==e)}removeQuestionByIds(e){if(this._element.questionList.slice(this._element.questionIndex).every(t=>e.includes(t.id)))throw new Error("无法直接删除所有待填写问题！");this._element.questionIndex=this._element.questionIndex-this._element.questionList.slice(0,this._element.questionIndex).filter(t=>!e.includes(t.id)).length,this._element.questionList=this._element.questionList.filter(t=>!e.includes(t.id))}addQuestion(e,t=-1){t===-1?this._element.questionList.push(e):this._element.questionList.splice(t+1,0,e),this._element.requestUpdate()}addQuestions(e,t=-1){t===-1?this._element.questionList.push(...e):this._element.questionList.splice(t,0,...e),this._element.requestUpdate()}on(e,t){const o=n=>{t(n.detail)};this._element.addEventListener(e,o),this._listenerDestroyers.push(()=>{this._element.removeEventListener(e,o)})}};const g=s.isServer?null:w,b=s.isServer?null:y;i.UserSatisfactionElement=g,i.UserSatisfactionSurvey=b,Object.defineProperty(i,Symbol.toStringTag,{value:"Module"})});
